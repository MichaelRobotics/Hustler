...
const totalPassed = testResults.websocket.passed + testResults.websocketIntegration.passed + testResults.phase5.passed;
const totalFailed = testResults.websocket.failed + testResults.websocketIntegration.failed + testResults.phase5.failed;
const totalTests = testResults.websocket.total + testResults.websocketIntegration.total + testResults.phase5.total;
...
console.log('  • POST /api/websocket/connect - WebSocket connection management');
...
console.log('  • GET /api/reports/business-insights - Business insights reports');
console.log('  • GET /api/reports/funnel-performance - Funnel performance reports');
