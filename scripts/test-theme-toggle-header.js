...
function testThemeToggleImplementation() {
  ...
  console.log('        )}');
  console.log('        <div>');
  console.log('          <Text size="3" weight="semi-bold">AI Assistant</Text>');
  console.log('        </div>');
  console.log('      </div>');
  console.log('      ');
  ...
  console.log('        className="p-2 rounded-full touch-manipulation active:bg-gray-100 dark:active:bg-gray-700 transition-all duration-200 hover:scale-105"');
  console.log('        title={appearance === \'dark\' ? \'Switch to light mode\' : \'Switch to dark mode\'}');
  console.log('      >');
  console.log('        {appearance === \'dark\' ? (');
  console.log('          <Sun size={20} className="text-gray-600 dark:text-gray-300" />');
  console.log('        ) : (');
  console.log('          <Moon size={20} className="text-gray-600 dark:text-gray-300" />');
  console.log('        )}');
  console.log('      </button>');
  console.log('    </div>');
  console.log('    ```');
...
function testHeaderLayout() {
  ...
  console.log('\n  Layout Features:');
  console.log('    - ✅ `flex items-center justify-between` - Proper header layout');
...
function testButtonStyling() {
  ...
  console.log('    - ✅ `active:bg-gray-100 dark:active:bg-gray-700` - Press feedback');
