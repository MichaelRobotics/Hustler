 ...
 */
async function removeResourceFromFunnelHandler(request: NextRequest, context: AuthContext) {
  try {
    const { user } = context;
    ...
    return createSuccessResponse(null, 'Resource removed from funnel successfully');
  } catch (error) {
