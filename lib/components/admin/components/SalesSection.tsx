...
import { ProductSale, SalesTotal } from '../../../utils/adminAnalytics';
...
const SalesSection: React.FC<SalesSectionProps> = ({
  ...
  const getColorClasses = (scheme: string) => {
    const colors = {
      pink: {
        ...
        cardBg: 'from-pink-100/50 via-pink-200/40 to-rose-100/30 dark:from-green-800/50 dark:via-green-700/40 dark:to-emerald-800/30',
        cardBorder: 'border-pink-300/50 dark:border-green-600/50',
        productBg: 'from-white/60 via-white/40 to-pink-50/20 dark:from-gray-800/60 dark:via-gray-700/40 dark:to-green-900/20',
      ...
      blue: {
        ...
        cardBg: 'from-blue-100/50 via-blue-200/40 to-indigo-100/30 dark:from-blue-800/50 dark:via-blue-700/40 dark:to-indigo-800/30',
        cardBorder: 'border-blue-300/50 dark:border-blue-600/50',
        productBg: 'from-white/60 via-white/40 to-blue-50/20 dark:from-gray-800/60 dark:via-gray-700/40 dark:to-blue-900/20',
      ...
      green: {
        ...
        cardBg: 'from-green-100/50 via-green-200/40 to-emerald-100/30 dark:from-green-800/50 dark:via-green-700/40 dark:to-emerald-800/30',
        cardBorder: 'border-green-300/50 dark:border-green-600/50',
        productBg: 'from-white/60 via-white/40 to-green-50/20 dark:from-gray-800/60 dark:via-gray-700/40 dark:to-green-900/20',
      ...
      slate: {
        ...
        cardBg: 'from-slate-100/50 via-slate-200/40 to-gray-100/30 dark:from-slate-800/50 dark:via-slate-700/40 dark:to-gray-800/30',
        cardBorder: 'border-slate-300/50 dark:border-slate-600/50',
        productBg: 'from-white/60 via-white/40 to-slate-50/20 dark:from-gray-800/60 dark:via-gray-700/40 dark:to-slate-900/20',
  ...
  return (
    <div className={`bg-gradient-to-br ${colors.bg} p-6 rounded-xl border ${colors.border}`}>
      <div className="flex items-center gap-3 mb-6">
        <div className={`p-2 rounded-lg ${colors.iconBg}`}>
          <div className={`h-5 w-5 ${colors.iconColor}`}>
            {icon}
          </div>
        </div>
        <div>
      ...
      {/* Total Revenue Card */}
      <div className={`bg-gradient-to-br ${colors.cardBg} p-6 rounded-lg mb-6 border-2 ${colors.cardBorder}`}>
        <div className="flex items-center justify-between">
          <div>
            <Text size="2" weight="bold" className="text-black dark:text-white block mb-3">
              TOTAL REVENUE
            </Text>
            <Text size="1" color="gray" className="text-muted-foreground block">
              <span className="text-black dark:text-white">{total.sales}</span> sales
            </Text>
          </div>
