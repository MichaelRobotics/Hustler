...
export const mockFunnelFlow: FunnelFlow = {
  ...
  blocks: {
    'welcome_1': {
      id: 'welcome_1',
      message: '👋 Hi there! I\'m your AI assistant. What brings you here today?\n\nAnswer by pasting one of those numbers',
      options: [
        { text: 'I need help growing my business', nextBlockId: 'business_challenge' },
        { text: 'I want to improve myself personally', nextBlockId: 'personal_challenge' }
      ]
    },
    'business_challenge': {
      id: 'business_challenge',
      message: '🚀 Great! What\'s your biggest business challenge right now?\n\nAnswer by pasting one of those numbers',
      options: [
        { text: 'Getting more customers', nextBlockId: 'business_goal' },
        { text: 'Converting visitors to customers', nextBlockId: 'business_goal' },
        { text: 'Scaling my operations', nextBlockId: 'business_goal' }
      ]
    },
    'business_goal': {
      id: 'business_goal',
      message: '🎯 What would you like to achieve in the next 3 months?\n\nAnswer by pasting one of those numbers',
      options: [
    ...
    'business_timeline': {
      ...
      message: '⏰ How quickly do you want to see results?\n\nAnswer by pasting one of those numbers',
      options: [
    ...
    'personal_goal': {
      id: 'personal_goal',
      message: '💪 What would you like to achieve in the next 30 days?\n\nAnswer by pasting one of those numbers',
      options: [
        { text: 'Build unshakeable confidence', nextBlockId: 'personal_timeline' },
    ...
    'personal_timeline': {
      ...
      message: '⏰ How committed are you to making this change?\n\nAnswer by pasting one of those numbers',
      options: [
